  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className={`cursor-pointer transition-colors duration-300 ${isHomepage ? 'text-white hover:text-emerald-100' : 'text-emerald-700 hover:text-emerald-600'}`}
      >
        {item}
      </motion.p>
      {active !== null && (
        ...
        >
          {active === item && (
            <div className="absolute top-[calc(100%_+_1.0rem)] left-1/2 transform -translate-x-1/2 pt-2">
              <motion.div
                transition={transition}
  ...
  return (
    <a href={href} className="flex space-x-2">
      ...
      <div>
        ...
        <p className="text-neutral-200 text-sm max-w-[10rem]">
          {description}
        </p>
      </div>
    </a>
