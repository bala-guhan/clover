...
import { internshipData } from "@/data/internship-info";
import PopperButton from '../components/popper-button';

export default function Internship() {
    const handleStartJourney = () => {
        console.log('Start Internship Journey clicked!');
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                            Follow our structured 24-week program designed to transform your profile and enhance your competitiveness for global opportunities.
                        </p>
                    </motion.div>
                    ...
                    <div className="relative">
                        {/* Timeline Line */}
                        <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-emerald-300 transform md:-translate-x-0.5"></div>

                        {/* Timeline Steps */}
                        <div className="space-y-12">
                            {internshipData.timeline.map((step, index) => (
                                <motion.div
                                    key={step.step}
                                ...
                                >
                                    {/* Timeline Dot */}
                                    <div className="absolute left-8 md:left-1/2 w-4 h-4 bg-emerald-600 rounded-full transform -translate-x-2 md:-translate-x-2 z-10 border-4 border-white shadow-lg"></div>
                ...
                <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
                    ...
                    >
                        <blockquote className="text-xl md:text-2xl text-emerald-900 font-medium leading-relaxed italic">
                            "{internshipData.objective}"
                        </blockquote>
                        
                        <div className="pt-8">
                            <PopperButton
                                text={internshipData.ctaButton.text}
